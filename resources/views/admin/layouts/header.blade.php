                      ...
                      <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                              ...
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/1.jpg') }}"
                                      ...
                                      <div class="d-flex align-items-center justify-content-between mb-0">
                                          <div class="mb-0 fs-13 fw-medium">
                                              ...
                                              <div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
                                                  <div class="text-default"><span class="text-primary">Qty :</span>
                                                      1</div>
                                                  <div class="text-default"><span class="text-muted op-5">|</span>
                                                  </div>
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/2.jpg') }}"
                                              alt="Smartwatch">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/5.jpg') }}"
                                              alt="Gaming Laptop">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/7.jpg') }}"
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/8.jpg') }}"
                                              alt="Fitness Tracker">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-md bg-gray-300">
                                          <img src="{{ asset('admin/assets/images/ecommerce/jpg/3.jpg') }}"
                                              alt="DSLR Camera">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                  ...
                  <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                      ...
                      <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                  ...
                                  <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                      <div class="fs-13">
                                          <div class="text-muted">
                                              <a href="javascript:void(0);" class="fw-medium">Purni </a>commented on
                                              your <span class="fw-medium text-default">post</span>
                                          </div>
                                      ...
                                      <div class="fs-13">
                                          <div class="text-muted">
                                              Updated the <a href="javascript:void(0);"
                                                  class="fw-medium text-default">order details</a> for your purchase.
                                          </div>
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center gap-3">
                                  ...
                                  <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                      <div class="fs-13">
                                          <div class="text-muted">
                                              <a href="javascript:void(0);" class="fw-medium">Priya Sharma</a> sent
                                              you a <span class="fw-medium text-default">follow request</span>.
                                          </div>
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center gap-3">
                                  <span class="avatar avatar-md flex-shrink-0">
                                      <img src="{{ asset('admin/assets/images/faces/12.jpg') }}" alt="img">
                                      <a href="javascript:void(0);"
                                          class="badge rounded-pill bg-primary avatar-badge"><i
                                  ...
                                  <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                      <div class="fs-13">
                                          <div class="text-muted">
                                              <a href="javascript:void(0);" class="fw-medium">Amit Patel</a> sent
                                              you a <span class="fw-medium text-default">money transfer</span> of
                                              ₹15,000.
                                          </div>
                          ...
                          <li class="dropdown-item">
                              <div class="d-flex align-items-center gap-3">
                                  <span class="avatar avatar-md flex-shrink-0">
                                      <img src="{{ asset('admin/assets/images/faces/4.jpg') }}" alt="img">
                                      <a href="javascript:void(0);"
                                          class="badge rounded-pill bg-warning avatar-badge"><i
                                  ...
                                  <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                      <div class="fs-13">
                                          <div class="text-muted">
                                              <a href="javascript:void(0);" class="fw-medium">Neha Verma</a> replied
                                              to your <span class="fw-medium text-default">message</span>.
                                          </div>
              ...
              <li class="header-element dropdown">
                  ...
                  <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                      ...
                      <div class="d-flex align-items-center">
                          <div>
                              <img src="{{ asset('admin/assets/images/faces/10.jpg') }}" alt="img"
                  ...
                  <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                      ...
                      <li class="p-3 border-bottom">
                          <div class="d-flex align-items-center justify-content-center text-center">
                              <div>
                                  <p class="mb-0 fw-semibold lh-1">{{ auth()->user()->username ?? '' }}</p>
                      ...
                      <li>
                          <a class="dropdown-item d-flex align-items-center"
                              ...
                              <i class="ri-user-line fs-15 me-2 text-gray fw-normal"></i>Profile
                          </a>
                      </li>
                      ...
                      <li>
                          <a href="#" class="dropdown-item d-flex align-items-center"
                              ...
                              <i class="ri-logout-circle-line fs-15 me-2 text-gray fw-normal"></i>Sign Out
                          </a>
                      </li>
                          ...
                          <nav class="border-top border-block-start-dashed">
                              <div class="nav nav-tabs nav-justified" id="switcher-main-tab" role="tablist">
                                  <button class="nav-link active" id="switcher-home-tab" data-bs-toggle="tab"
                                      ...
                                      aria-controls="switcher-home" aria-selected="true">Theme Styles</button>
                          ...
                          <div class="tab-content" id="nav-tabContent">
                                          ...
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                                  ...
                                                  <input class="form-check-input" type="radio"
                                                      name="navigation-style" id="switcher-vertical" checked>
                                              </div>
                                          </div>
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                                  ...
                                                  <input class="form-check-input" type="radio"
                                                      name="navigation-style" id="switcher-horizontal">
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                                      ...
                                      <div class="row switcher-style gx-0 pb-2 gy-2">
                                          ...
                                          <div class="col-sm-6">
                                              <div class="form-check switch-select">
                                                  ...
                                                  <input class="form-check-input" type="radio"
                                                      name="sidemenu-layout-styles" id="switcher-icontext-menu">
                                              </div>
                                          </div>
                                          <div class="col-sm-6">
                                              <div class="form-check switch-select">
                                      ...
                                      <div class="row switcher-style gx-0">
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                                  ...
                                                  <input class="form-check-input" type="radio"
                                                      name="menu-positions" id="switcher-menu-fixed" checked>
                                              </div>
                                          </div>
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                      ...
                                      <div class="row switcher-style gx-0">
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                                  ...
                                                  <input class="form-check-input" type="radio"
                                                      name="header-positions" id="switcher-header-fixed" checked>
                                              </div>
                                          </div>
                                          <div class="col-4">
                                              <div class="form-check switch-select">
                                          ...
                                          <div class="d-flex switcher-style pb-2">
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-white"
                                                      ...
                                                      title="Light Menu" type="radio" name="menu-colors"
                                                      id="switcher-menu-light" checked>
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-dark"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Dark Menu" type="radio" name="menu-colors"
                                                      id="switcher-menu-dark">
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-primary"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Color Menu" type="radio" name="menu-colors"
                                                      id="switcher-menu-primary">
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-gradient"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Gradient Menu" type="radio" name="menu-colors"
                                                      id="switcher-menu-gradient">
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-transparent"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Transparent Menu" type="radio" name="menu-colors"
                                      ...
                                      <div class="theme-colors">
                                          ...
                                          <div class="d-flex switcher-style pb-2">
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-white"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Light Header" type="radio" name="header-colors"
                                                      id="switcher-header-light" checked>
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-dark"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Dark Header" type="radio" name="header-colors"
                                                      id="switcher-header-dark">
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-primary"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Color Header" type="radio" name="header-colors"
                                                      id="switcher-header-primary">
                                              </div>
                                              <div class="form-check switch-select me-3">
                                                  <input class="form-check-input color-input color-gradient"
                                                      data-bs-toggle="tooltip" data-bs-placement="top"
                                                      title="Gradient Header" type="radio" name="header-colors"
                                          ...
                                          <div class="px-4 pb-3 text-muted fs-11">Note:If you want to change color
                                              Header
                                              dynamically
                                          ...
                                          <div class="d-flex flex-wrap align-items-center switcher-style">
                                              <div class="form-check switch-select m-2">
                                                  <input class="form-check-input bgimage-input bg-img1"
                                                      type="radio" name="menu-background" id="switcher-bg-img">
                                              </div>
                                              <div class="form-check switch-select m-2">
                                                  <input class="form-check-input bgimage-input bg-img2"
                                                      type="radio" name="menu-background" id="switcher-bg-img1">
                                              </div>
                                              <div class="form-check switch-select m-2">
                                                  <input class="form-check-input bgimage-input bg-img3"
                                                      type="radio" name="menu-background" id="switcher-bg-img2">
                                              </div>
                                              <div class="form-check switch-select m-2">
                                                  <input class="form-check-input bgimage-input bg-img4"
                                                      type="radio" name="menu-background" id="switcher-bg-img3">
                                              </div>
                                              <div class="form-check switch-select m-2">
                                                  <input class="form-check-input bgimage-input bg-img5"
                                                      type="radio" name="menu-background" id="switcher-bg-img4">
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="d-flex justify-content-center canvas-footer gap-1">
                                  <a href="javascript:void(0);" id="reset-all"
                                      class="btn btn-danger flex-fill">Reset</a>
                              </div>
                          </div>
                      </div>
                  </div>
