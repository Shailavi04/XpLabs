                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 mode-dependent" id="editMeetingPasswordDiv" style="display:none;">
                            <label>Meeting Password</label>
                            <input type="text" name="meeting_password" id="editMeetingPassword" class="form-control">
                        </div>
...
$(function() {
    ...
    $(document).on('click', '.edit-classroom-btn', function() {
        ...
        $.get("{{ url('classroom/edit') }}/" + id, function(response) {
            if(response.classroom) {
                ...
                $('#editClassroomForm').attr('action', "{{ url('classroom/update') }}/" + id);
    ...
    $('#classroom-table').DataTable({
        ...
        language: { searchPlaceholder: "Search classrooms...", search: "" }
    });
});
</script>
@endpush
