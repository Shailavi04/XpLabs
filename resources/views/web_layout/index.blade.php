...
<!-- Mirrored from dreamslms.dreamstechnologies.com/html/template/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jul 2025 04:09:58 GMT -->
<head>
		...
		<!-- Theme Settings Js -->
		<script src="assets/js/theme-script.js" type="63834a1d950dad5106effc44-text/javascript"></script>
	...
	<body>
													...
													<div class="row">
														...
														<div class="col-lg-2">
															<div class="single-demo active">
																<div class="demo-img">
																	<a href="index-4.html" class="inner-demo-img"><img src="assets/img/home/home-04.jpg" class="img-fluid " alt="img"></a>
																</div>
																<div class="demo-info">
														...
														<div class="col-lg-2">
															<div class="single-demo">
																<div class="demo-img">
																	<a href="index-5.html" class="inner-demo-img"><img src="assets/img/home/home-05.jpg" class="img-fluid " alt="img"></a>
																</div>
																<div class="demo-info">
														...
														<div class="col-lg-2">
															<div class="single-demo">
																<div class="demo-img">
																	<a href="index-6.html" class="inner-demo-img"><img src="assets/img/home/home-06.jpg" class="img-fluid " alt="img"></a>
																</div>
																<div class="demo-info">
							...
							<div class="col-lg-6 col-12" data-aos="fade-up">
								<div class="home-slide-face">
									...
									<div class="banner-form">
										<form class="form" name="store" id="store" method="post" action="https://dreamslms.dreamstechnologies.com/html/template/course-list.html">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">The Complete Web Developer PHP framework Course 2.0</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html" class="link-info">Emily Williams</a></p>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">Building Your Personal Brand: Tips for Career Success</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html"  class="link-info">Brook Salaine</a></p>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">Strength Training 101: Building a Solid Foundation</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html"  class="link-info">Mark Richardson</a></p>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">Digital Marketing Strategies for Business Growth</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html"  class="link-info">Laura Bennett</a></p>
												<p class="course-level text-purple">Basic</p>
											</div>
											<div class="course-info">
												<p class="course-time"><i class="fa-regular fa-clock me-2"></i>6hr 30min</p>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">Web Development for Beginners: HTML, CSS, and JavaScript</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html"  class="link-info">David Morgan</a></p>
												<p class="course-level">Expert</p>
											</div>
											<div class="course-info">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 d-flex" data-aos="fade-down">
									<div class="course-item course-item-four mx-0">
										...
										<div class="course-content">	
											...
											<h3 class="title"><a href="course-details.html">Photography Basics: Understanding Composition and Lighting</a></h3>
											<div class="user-info">
												<p class="user-name"><a href="instructor-details.html"  class="link-info">Maria Lopez</a></p>
							...
							<div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-down">	
								<div class="event-blog-main">
									...
									<div class="blog-content">
										...
										<h4 class="title"><a href="blog-details.html">Promoting Health & Well being in Schools</a></h4>
							...
							<div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-down">	
								<div class="event-blog-main">
									...
									<div class="blog-content">
										...
										<h4 class="title"><a href="blog-grid.html">Why an LMS is Essential for Modern Education</a></h4>
										<p class="blog-date"><i class="isax isax-calendar-1 me-1"></i>14 Sep 2022</p>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-down">	
								<div class="event-blog-main">
									...
									<div class="blog-content">
										...
										<h4 class="title"><a href="blog-details.html">11 Tips to Help You Get New Clients with the design</a></h4>
										<p class="blog-date"><i class="isax isax-calendar-1 me-1"></i>14 Sep 2022</p>
									</div>
								</div>
							</div>
											...
											<div class="footer-widget footer-contact">
												...
												<div class="footer-contact-info">
													...
													<div class="footer-address d-flex align-items-center">
														...
														<p><a href="https://dreamslms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1d796f787c706e71706e5d78657c706d7178337e7270">[email&#160;protected]</a></p>
													</div>
													<div class="footer-address d-flex align-items-center">
	   ...
	   <!-- /Main Wrapper -->
		...
		<!-- jQuery -->
		<script data-cfasync="false" src="https://dreamslms.dreamstechnologies.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="assets/js/bootstrap.bundle.min.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		
		<!-- counterup JS -->
		<script src="assets/js/jquery.waypoints.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		<script src="assets/js/jquery.counterup.min.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		
		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="63834a1d950dad5106effc44-text/javascript"></script>

		<!-- Owl Carousel -->
		<script src="assets/js/owl.carousel.min.js" type="63834a1d950dad5106effc44-text/javascript"></script>	

		<!-- Slick Slider -->
		<script src="assets/plugins/slick/slick.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		
		<!-- Aos -->
		<script src="assets/plugins/aos/aos.js" type="63834a1d950dad5106effc44-text/javascript"></script>
		
		<!-- Custom JS -->
		<script src="assets/js/script.js" type="63834a1d950dad5106effc44-text/javascript"></script>
...
<!-- Mirrored from dreamslms.dreamstechnologies.com/html/template/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jul 2025 04:13:05 GMT -->
</html>